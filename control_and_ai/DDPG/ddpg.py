...
class DDPG():
    def __init__(self, 
        ...
        self.actor = Actor(self.sess, action_space_bounds, exploration_policies, env_space_size, actor_learning_rate, optimizer=tf.optimizers.Adam)#optimizer=tf.train.AdamOptimizer)
        self.critic = Critic(self.sess, len(action_space_bounds), env_space_size, critic_learning_rate, gamma, optimizer=tf.optimizers.Adam)#optimizer=tf.train.AdamOptimizer)
